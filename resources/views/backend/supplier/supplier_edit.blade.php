            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{route('suppliers.list')}}">Inventory</a></li>
                        <li class="breadcrumb-item"><a href="{{route('suppliers.list')}}">Suppliers</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('supplier.update') }}" id="myForm" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="phone" class="form-control" value="{{$supplier->phone}}" type="number">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Supplier Email Address</label>
                                    <div class="form-group col-sm-10">
